...
pub const WIN_FONTS: &[&str] = &[
    ...
    "Georgia", "Impact", "Javanese Text", "Lucida Console", "Lucida Sans Unicode", "Malgun Gothic",
    "Marlett", "Microsoft Himalaya", "Microsoft JhengHei", "Microsoft New Tai Lue",
    "Microsoft Sans Serif", "Microsoft Tai Le", "Mongolian Baiti", "MS Gothic", "MV Boli",
...
pub const MAC_FONTS: &[&str] = &[
    "Al Bayan", "American Typewriter", "Andale Mono", "Apple Color Emoji", "AppleGothic",
    "Arial", "Arial Hebrew", "Arial Rounded MT Bold", "Avenir", "Avenir Next",
    "Baskerville", "Bodoni 72", "Bradley Hand", "Brush Script MT", "Chalkboard",
    "Chalkduster", "Charter", "Cochin", "Comic Sans MS", "Copperplate", "Courier New",
    ...
    "Microsoft Sans Serif", "Monaco", "Mukta Mahee", "Noteworthy", "Optima", "Palatino",
    "Papyrus", "Phosphate", "Rockwell", "Savoye LET", "SignPainter", "Skia", "Snell Roundhand",
    "Stencil", "Syilahar New", "Tahoma", "Times", "Times New Roman", "Trattatello",
    "Trebuchet MS", "Verdana", "Zapfino",
];

pub const LINUX_FONTS: &[&str] = &[
    "DejaVu Sans", "DejaVu Sans Mono", "DejaVu Serif", "FreeMono", "FreeSans", "FreeSerif",
    "Liberation Mono", "Liberation Sans", "Liberation Serif", "Liberation Sans Narrow",
    "Nimbus Sans", "Nimbus Mono", "Nimbus Roman", "Noto Sans", "Noto Sans Mono", "Noto Serif",
